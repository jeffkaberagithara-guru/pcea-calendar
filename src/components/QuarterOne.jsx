...
function QuarterOne({ events, onEventSelect, selectedEvent, filterType = 'all' }) {
    ...
    return (
        <div id="quarter-one" className="quarter-container rounded-xl border border-gray-200 bg-white overflow-hidden shadow-sm mb-6 scroll-mt-6">
            <div className={`px-4 py-3 flex items-center justify-between ${theme.headerGradient}`}>
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={() => {
                            const lastQuarter = document.getElementById('quarter-three');
                            lastQuarter?.scrollIntoView({ behavior: 'smooth' });
                        }}
                    ...
                    <button
                        onClick={() => {
                            const nextQuarter = document.getElementById('quarter-two');
